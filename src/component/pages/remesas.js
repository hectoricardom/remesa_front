                  ...
                  */}
                  {validForm ? 
                    <div className={'_w100  _dsplFlx spaceAround'}  >
                      <MoreInfoButton title={`Comenzar`} value={amount} theme={"purple"}  clickEvent={()=>setChoosePayView(1)} />
                    </div>
                    :null}
                    </>
                    :null}
                  ...
                  <div className={`formContainer`} style={{opacity:choosePayView === 1?1:0}}>
                    ...
                    <> 
                      ...
                      <div className={`margField`}>
                          <div className={'_w100  _dsplFlx spaceAround'} >
                            <MoreInfoButton title={`Cancelar`}  theme={"gray"}  clickEvent={()=>setChoosePayView(0)} />
                          </div>
                        </div>
                    </>
                    :null}
