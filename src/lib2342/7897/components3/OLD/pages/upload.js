      ...
      <Layout />
        <div className={`_dsplFlx _operationsWrp_`}>
          ...
          <div  className={` _wrpSld_ `}>
            <div className={` _wrpView_ _upload_video_  ${view===0 && 'visible'}`}  onDrop={(e)=>dropHandler(e)} onDragOver={(e)=>dragOverHandler(e)}>    
                {view===0 && 
                  <input type={`file`} style={inputFileStyle} id={uploadID} onChange={(e)=>fileCheckInput(e,uploadID, label, setLabel, fileName, setFileName)}  accept="video/*" upload-type-label={`${'uploadVideo'}`}/>   
                }
            </div>
            <div className={`_wrpView_ ${view===1 && 'visible'}`}>
            {view=== 1 && 
              <div>
                        ...
                        <div className={'_dsplFlx flxbsc30'}>
                          <div className={'_dsplFlx  hide_when_action'}>                         
                            <div className={'coLTd  flxbsc5 _total2 '}>
                                <div  className={'locations _link_'}> {slc && slc['originalFile'] &&  parseSize(slc['originalFile']['size'])}</div>
                            </div>
                            <div className="flexSpace"/>  
